...
At the University of Córdoba, I teach an introductory [course for Data Analysis](CursoAnalisisDatos/cursoR.html){:target="_blank"}) using the `R` programming language.  We have already run 4 editions and the course usually gets some very nice reviews and positive feedbacks from our students.   
